...
public class EditCurrentUserCommand extends Command {
    ...
    private Component makeComponent(Bot bot, Object... values) {
        ...
        Paragraph paragraph = new Paragraph("List of items the current user has interacted with.");
        ...
        item.setUrl(URI.create("https://www.amazon.com/Samsung-Computer-Touchscreen-Speakers-NP750QHA-KA1US/dp/B0DSLNMY6M/ref=sr_1_1_sspa?crid=1JVLTJCV5T3S4&dib=eyJ2IjoiMSJ9.8h14joHyf6QLrsy0A_ITBSpPZ4QQoGMSK6s7lsYlcrjPXYytJq_oXaHOK5_sNvU4QV-P3PZJEmQhCNceNUO1lyw4MsOuUDdaUHFjoGLTSTyXJaNGlD2TDWXVr9f2X-B1wZ3uOm7sHU8yEUOV3IcmYWMZJ8MIr8sMxr3x3euDkYv0gGwdhItLWWLZHqsBhOTZeBvlc2h6RdXVSF0MuavZL1OmqpnJuP9idcQfi-CfswQ.AzriAHFQCoHxx2Cy2529YSfDfvb8Ya_BHCWBGKaSKfQ&dib_tag=se&keywords=laptop&qid=1764334361&sprefix=laptop%2Caps%2C252&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1"));
        items.add(item);
        ...
        return new VerticalLayout(header, paragraph, grid, addForm, backButton);
    }
}